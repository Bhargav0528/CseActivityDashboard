...
resume()
{
	...
	key1.on("value",function(snapshot){  var x=snapshot.val(); }, function(error){});
	var x;
	var i;
...
render() {
	...
	<li className="studentProfileDefault"><tr className="studentProfileDefault"><label>Known languages: </label> </tr>      <td className="studentProfileDefault">  <textarea className="studentProfileDefault" id="7" rows="2" cols="10"></textarea></td> </li><br/><br/><br/><br/>
