...
class Internship extends React.Component{
	...
	render(){
		...
		<p className="internship1"><b>Internship Description: </b></p><pre className="internship1">{this.state.description}</pre>
...
class NewInternship extends React.Component{
   ...
   handleChange1 = minitestoptions => {
	...
	render(){
		...
		<tr className="formClass"><th className="formClass">Min. Students Required:*</th><td className="formClass"><input type="number" min="0" name="studentreq" onChange={this.changedState}/></td></tr>
