...
class OpenInternship extends React.Component{
	...
	render(){
		...
		<div className="popup" id="popup"></div></div>:<div><br/><br/><img src="loadingicon.png" className="loadingicon"/></div>}
		</div>:(this.state.userValid==null?<div><h1>Loading</h1></div>:<div><p className="unauthorisedAccess">Access Denied</p><span className="unauthorisedAccess">You are not allowed access to this page. If you are supposed to be able to access this page, try logging in again.</span></div>)}
		</div>
		);
	}
}
